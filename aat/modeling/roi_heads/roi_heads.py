...
from aat.modeling.roi_heads.fast_rcnn import PseudoFastRCNNOutputLayers
...
class PseudoROIHeads(StandardROIHeads):
    """
    StandardROIHeads with PseudoFastRCNNOutputLayers as box_predictor
    """
    ...
    def _init_box_head(cls, cfg, input_shape):
        ...
        box_predictor = PseudoFastRCNNOutputLayers(cfg, box_head.output_shape)
