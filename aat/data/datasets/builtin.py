...
_RAW_FOGGY_CITYSCAPES_SPLITS = {
    ...
    "cityscapes_foggy_train": (
        "cityscapes_foggy/leftImg8bit/train/",
        "cityscapes_foggy/gtFine/train/",
    ),
    "cityscapes_foggy_val": (
        "cityscapes_foggy/leftImg8bit/val/",
        "cityscapes_foggy/gtFine/val/",
    ),
}
...
def register_all_pascal_voc(root):
    SPLITS = [
        ("voc07_trainval", "VOC2007", "trainval"),
        ("voc12_trainval", "VOC2012", "trainval"),
        ("voc_val", "VOC2012", "val"),
    ]
    for name, dirname, split in SPLITS:
